...
export default function Dashboard(){
 ...
 return <div className="sk-page sk-dashboard" aria-busy={!data&&!error}>
  ...
  <div className="sk-metrics">
   ...
   <Metric icon="stack" title="Aktywne kampanie" value={data?campaigns.filter(c=>campaignView(c).statusKey==='active').length:'—'} detail={`z ${campaigns.length} wszystkich`} tone="blue"/>
