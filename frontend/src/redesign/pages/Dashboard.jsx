...
export default function Dashboard(){
 ...
 return <div className="sk-page sk-dashboard">
  ...
  <div className="sk-two-col"><Panel title="Aktywność wysyłki" icon="flash" action={<select aria-label="Zakres wykresu" value={days} onChange={e=>setDays(+e.target.value)} style={{width:130,fontSize:11,padding:'5px 22px 5px 9px'}}><option value={7}>Ostatnie 7 dni</option><option value={14}>Ostatnie 14 dni</option></select>}><ActivityChart rows={daily} days={days}/></Panel>
